...
namespace DaySim.ChoiceModels.Default.Models {
  class BKR_OtherTourDestinationModel : OtherTourDestinationModel {
    ...
    protected override void RegionSpecificOtherTourDistrictCoefficients(ChoiceProbabilityCalculator.Alternative alternative, ITourWrapper _tour, IParcelWrapper destinationParcel, IPersonWrapper _person) {
