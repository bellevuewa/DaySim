  ...
  class BKR_OtherHomeBasedTourModeModel : OtherHomeBasedTourModeModel {
    protected override void RegionSpecificCustomizations(ChoiceProbabilityCalculator.Alternative alternative, ITourWrapper tour, int pathType, int mode, IParcelWrapper destinationParcel) {
      ...
      if (mode == Global.Settings.Modes.ParkAndRide) {
        ...
        //alternative.AddUtilityTerm(302, destdist == 60 ? 1 : 0);
        //alternative.AddUtilityTerm(303, destdist == 61 ? 1 : 0);
        //alternative.AddUtilityTerm(304, destdist == 62 ? 1 : 0);
        //alternative.AddUtilityTerm(305, destdist == 63 ? 1 : 0);
        //alternative.AddUtilityTerm(306, destdist == 64 ? 1 : 0);
        //alternative.AddUtilityTerm(307, destdist == 65 ? 1 : 0);
        //alternative.AddUtilityTerm(308, destBKR == 1 ? 1 : 0);
        //alternative.AddUtilityTerm(316, destdist == 66 ? 1 : 0);
      }
    }
  }
}
